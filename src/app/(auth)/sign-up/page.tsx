...
export default function SignUpForm() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-blue-800">
      <div className="w-full max-w-md p-8 space-y-8 bg-blue-900 rounded-lg shadow-md">
        <div className="text-center">
          <h1 className="text-4xl font-extrabold tracking-tight lg:text-5xl mb-6 text-white">
            New to FeedBack Matters? SignUp by just using an email!
          </h1>
          <p className="mb-4 text-blue-300">
            Sign up to recieve feedbacks anonymously!
          </p>
        </div>
        <Form {...form}>
